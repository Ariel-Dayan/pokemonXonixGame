...
window.onload = function() {
    enemySlider = document.getElementById("enemyRange");
    enemtOutput = document.getElementById("enemyValue");
    enemyNum = enemySlider.value;
    liveSlider = document.getElementById("liveRange");
    liveOutput = document.getElementById("liveValue");
